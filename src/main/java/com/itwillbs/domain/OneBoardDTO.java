...
public class OneBoardDTO {
	...
	private String one_board_repDay;
	...
	public String getOne_board_repDay() {
		return one_board_repDay;
	}
	public void setOne_board_repDay(String one_board_repDay) {
		this.one_board_repDay = one_board_repDay;
	}
