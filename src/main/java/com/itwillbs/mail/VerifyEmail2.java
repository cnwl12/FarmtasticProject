...
public class VerifyEmail2 {
	
    // 랜덤 인증번호 생성 메서드
    public static String generateVerificationCode2() {
	...
	static String content = generateVerificationCode2();
		
	public String sendEmail2(String receiverEmail) {
