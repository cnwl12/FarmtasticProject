...
<body>
  ...
  <script type="text/javascript">
    ...
    var webSocket = new WebSocket("ws://c2d2303t2.itwillbs.com/FarmProject/adminrealtimechatBot");
    ...
    webSocket.onmessage = function(message) {
      ...
      // message는 유저가 메시지를 보낼 때 알려주는 메시지이다.
        ...
        // 아래에 메시지를 추가한다.
        $div.find(".console").val(log + "[me] => " +node.message + "\n");
    ...
    $(document).on("click", ".sendBtn", function(){
      ...
      let log = $div.find(".console").val();
      // 아래에 메시지를 추가한다.
      $div.find(".console").val(log + "[Farmtastic] => " + message + "\n");
      // 텍스트 박스의 값을 초기화 한다.
