...
<div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">제철팜글쓰기</h1>
					 <!-- DataTales Example -->
	...
	<script>
  		function blogUpdatePro(admin_blog_num) {
    		window.location.href = "${pageContext.request.contextPath}/blogUpdate?admin_blog_num=" + admin_blog_num;
 		}
	</script>
	<script>
  		function blogDelete(admin_blog_num) {
    		if (confirm("정말로 이 글을 삭제하시겠습니까?")) {
     		 window.location.href = "${pageContext.request.contextPath}/blogDelete?admin_blog_num=" + admin_blog_num;
   			 }
  		}
	</script>
	<script>
