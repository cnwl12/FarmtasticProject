        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
					...
					<p class="sub-text text-primary" ng-if="!vm.hasModel">상품과 맞지 않는 카테고리에 등록할 경우 강제 이동되거나 판매중지, 판매금지 될 수 있습니다.</p><!----><!----><!----><!----></div></div><!----></div></div><!----></div></ui-view>
					<!-- 카테고리 선택 끝 -->
					...
					<label class="col-lg-2 col-sm-3 col-xs-6 control-label">상품명</label>
					</div><!----><div class="inner-content input-content" ng-if="vm.isMenuOpen"><div class="form-section-sub"><div class="form-sub-wrap"><div class="input-content"><div class="form-group"><div class="input-group"><div class="seller-input-wrap"><input name="product.name" type="text" class="form-control ng-pristine ng-untouched ng-empty ng-invalid ng-invalid-required ng-valid-pattern ng-valid-maxlength" ng-model="vm.product.name" required="" ng-pattern-err-type="invalidSpecialCharacter" ng-maxlength="100" maxlength="100" title="상품명 입력" ncp-input-clear=""><a role="button" class="btn-clear" tabindex="-1" style="display:none;"><span aria-label="삭제">×</span></a></div><span class="input-group-addon"><span class="text-primary">0</span>/100</span></div></div><!---->
					<p class="sub-text text-primary">판매 상품과 직접 관련이 없는 다른 상품명, 스팸성 키워드 입력 시 관리자에 의해 판매 금지될 수 있습니다.</p>
					<p class="sub-text text-primary">유명 상품 유사문구를 무단으로 도용하여 ~스타일, ~st 등과 같이 기재하는 경우 별도 고지 없이 제재될 수 있습니다.</p>
					<p class="sub-text text-primary">전용 상품명을 사용 중인 경우 대표 상품명 수정 시에도 전용 상품명으로 노출됩니다.</p><p class="sub-text">
					<span class="text-primary">상품명을 검색최적화 가이드에 잘 맞게 입력하면 검색 노출에 도움이 될 수 있습니다.</span></p></div></div>
					<!----></div><!----></div><!----></div></ui-view>
					<!-- 상품명 등록 끝 -->  
