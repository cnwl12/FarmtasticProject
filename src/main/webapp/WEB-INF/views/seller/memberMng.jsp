...
<html lang="en">
    ...
    <body id="page-top">
                            ...
                            <form id="searchForm" name="vm.searchForm" method="get">
                                <div class="panel-body">
                                    <div class="seller-search-section">
                                        <ul class="seller-list-border">
                                            <li>
                                                <label class="control-label">회원 검색</label>
                                ...
                                <div class="panel-footer">
                                    <div class="seller-btn-area btn-group-lg">
                                        ...
                                        <!-- 초기화 버튼 추가 -->
                                        <button type="button" class="btn btn-default" onclick="resetForm()">초기화</button>
                                    </div>
                                </div>
                            </form>
                        </div>
        ...
        <script>
    		...
    		// memberMngPro action 속성 변경하여 폼 제출
    		const searchForm = document.getElementById('searchForm');
    		const searchButton = document.getElementById('searchButton');
    		searchButton.addEventListener('click', (event) => {
      		event.preventDefault();
      		searchForm.action = "${pageContext.request.contextPath}/memberMngPro";
      		searchForm.submit();
    	});
