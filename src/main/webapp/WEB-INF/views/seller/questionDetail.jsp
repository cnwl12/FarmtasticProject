...
<body>
 <div class="card shadow mb-4" id="questionMng">
  							...
  							<div class="table-responsive">
                                ...
                                <table class="table table-bordered" id="dataTable" >
                                    <tbody>
                                        ...
                                        <tr>
                                        <th>이미지</th>
                                        <td><img src="${questionDetail.one_board_file}" style="width:200px; height:200px;"></td>
                                        </tr>
                                        <tr>
                                        <th>답변</th>
								...
								<div>
								    <c:if test="${empty questionDetail.one_board_reply}">
								        <button onclick="opener.redirectToQuestionMngFromPopup(); window.close();">답변 등록하기</button>
								    </c:if>
								</div>
