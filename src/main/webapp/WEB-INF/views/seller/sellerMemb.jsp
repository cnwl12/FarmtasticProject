                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 mb-4">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">정산정보</h6>
                                </div>
                                <div class="card-body">
                                    <p class="mb-0">정산대금입금계좌:</p>
                                </div>
                            </div>
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">출고지주소</h6>
                                </div>
                                <div class="card-body">
                                    <p class="mb-0">주소</p>
                                </div>
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">반품주소</h6>
                                </div>
                                <div class="card-body">
                                    <p class="mb-0">주소</p>
                                </div>
