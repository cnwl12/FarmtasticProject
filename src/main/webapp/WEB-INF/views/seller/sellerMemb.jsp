...
<%-- 									<div class="form-control-static">${seller.seller_mobile} --%>
					...
					<div class="panel panel-seller">
						...
						<div class="panel-body">
							<!-- <div class="panel-body-info"></div> --><!-- 무슨 코드지? class명도 이 부분 혼자만 쓰는데. 일단 주석처리가 하니까 화면이 더 깔끔하게 보임 -->
							<ul class="seller-list-border">
								<li><label class="control-label" for="delivery-addr">출고지 주소</label>
								<div class="input-content">
										<div class="form-inline">
											<div class="form-group">
												<input type="text" class="form-control" value="상품출고지" id="delivery-addr" readonly="readonly">
											</div>
										</div>
										<div class="form-group">
											<input type="text" class="form-control" name="seller_post" value="${seller.seller_post}">
								...
								<li><label class="control-label long-label" for="return-addr">반품/<br class="visible-xs">교환지 주소
								</label>
								<div class="input-content">
										<div class="form-inline">
											<div class="form-group">
												<input type="text" class="form-control" value="반품교환지" id="return-addr" readonly="readonly">
											</div>
										</div>
										<div class="form-group">
											<input type="text" class="form-control" name="seller_addMain" value="(우:${seller.seller_post}) ${seller.seller_addMain} (${seller.seller_addSub}) " title="반품/교환지 주소">
										</div>
										<div class="form-inline">
											<div class="form-group">
